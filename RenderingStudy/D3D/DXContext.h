...
public:
    ...
    void SignalAndWait();
	//ID3D12GraphicsCommandList7* InitCommandList(); <- win10 에서 안됨
	...
	// inline ComPointer<ID3D12Device10>& GetDevice() { return m_device; } <- win10 에서 안됨
	inline ComPointer<ID3D12Device5>& GetDevice() { return m_device; }
